...
static struct {
	...
	IOP_IRQ_TYPE(IRQ_IOP_DMA_MDEC_IN,   "IOP DMAC MDEC IN"),
	IOP_IRQ_TYPE(IRQ_IOP_DMA_MDEC_OUT,  "IOP DMAC MDEC OUT"),
	IOP_IRQ_TYPE(IRQ_IOP_DMA_SIF2,      "IOP DMAC SIF2"),
	IOP_IRQ_TYPE(IRQ_IOP_DMA_CDVD,      "IOP DMAC CDVD"),
	IOP_IRQ_TYPE(IRQ_IOP_DMA_SPU,       "IOP DMAC SPU"),
	IOP_IRQ_TYPE(IRQ_IOP_DMA_PIO,       "IOP DMAC PIO"),
	IOP_IRQ_TYPE(IRQ_IOP_DMA_GPU_OTC,   "IOP DMAC GPU OTC"),
	IOP_IRQ_TYPE(IRQ_IOP_DMA_BE,        "IOP DMAC BE"),
	IOP_IRQ_TYPE(IRQ_IOP_DMA_SPU2,      "IOP DMAC SPU2"),
	IOP_IRQ_TYPE(IRQ_IOP_DMA_DEV9,      "IOP DMAC DEV9"),
	IOP_IRQ_TYPE(IRQ_IOP_DMA_SIF0,      "IOP DMAC SIF0"),
	IOP_IRQ_TYPE(IRQ_IOP_DMA_SIF1,      "IOP DMAC SIF1"),
	IOP_IRQ_TYPE(IRQ_IOP_DMA_SIO2_IN,   "IOP DMAC SIO2 IN"),
	IOP_IRQ_TYPE(IRQ_IOP_DMA_SIO2_OUT,  "IOP DMAC SIO2 OUT"),

	IOP_IRQ_TYPE(IRQ_IOP_SPD_ATA0,      "IOP SPD ATA0"),
	IOP_IRQ_TYPE(IRQ_IOP_SPD_ATA1,      "IOP SPD ATA1"),
	IOP_IRQ_TYPE(IRQ_IOP_SPD_TXDNV,     "IOP SPD TXDNV"),
	IOP_IRQ_TYPE(IRQ_IOP_SPD_RXDNV,     "IOP SPD RXDNV"),
	IOP_IRQ_TYPE(IRQ_IOP_SPD_TXEND,     "IOP SPD TXEND"),
	IOP_IRQ_TYPE(IRQ_IOP_SPD_RXEND,     "IOP SPD RXEND"),
	IOP_IRQ_TYPE(IRQ_IOP_SPD_EMAC3,     "IOP SPD EMAC3"),
	IOP_IRQ_TYPE(IRQ_IOP_SPD_DVR,       "IOP SPD DVR"),
	IOP_IRQ_TYPE(IRQ_IOP_SPD_UART,      "IOP SPD UART"),
